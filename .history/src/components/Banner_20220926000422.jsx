    ...
    <div className="h-[400px] bg-gray-200 mt-[48px]  ">
      <div className="container px-7 h-full md:w-[80%] md:mx-auto flex items-center ">
        <div className="wrap">
          ...
          />
          <div className="content -translate-y-5  flex flex-col ">
            <div className="   md:first-letter:text-3xl lg:text-4xl ">
              <span className="py-2  bg-white border-b-1 border-b-black ">
