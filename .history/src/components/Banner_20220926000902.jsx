      ...
      <div className="container px-7 h-full md:w-[80%] md:mx-auto flex items-center ">
        <div className="wrap">
          ...
          <div className="content  ">
            <h1 className="relative  font-bolder  md:text-3xl lg:">
              <h1 className="bg-white border-b-[.1px]  border-b-black relative">
                Be Inspired With Dark
              </h1>
              <span className="bg-white border-b-[.1px]  border-b-black  relative">
                Photo And Colorul
              </span>
              <br />
              <span className="bg-white border-b-[.1px] border-b-black ">
                Indoor Style
              </span>
            </h1>
