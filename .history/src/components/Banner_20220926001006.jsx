        ...
        <div className="wrap">
          ...
          <div className="content  ">
            <h1 className="relative  font-bolder  md:text-3xl lg:text-4xl ">
              <h1 className="bg-white border-b-[.1px]  border-b-black mb-[.3rem ] px-3 py-2 relative">
                Be Inspired With Dark
              </h1>
              <span className="bg-white border-b-[.1px]  border-b-black  mb-[.3rem ] px-3 py-2  relative">
                Photo And Colorul
              </span>
              <br />
