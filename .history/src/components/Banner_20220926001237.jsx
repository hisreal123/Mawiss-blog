        ...
        <div className="wrap">
          ...
          <div className="content  ">
            <h1 className="relative  font-bolder  md:text-3xl lg:text-4xl ">
              <h1 className="bg-white border-b-[.1px]  border-b-black mb-[9px] px-2 py-2 relative">
                Be Inspired With Dark
              </h1>
              <span className="bg-white border-b-[.1px]  border-b-black mb-[4px] px-2 py-1 relative">
                Photo And Colorul
              </span>
              <br />
              <span className="bg-white border-b-[.1px] mt-[4px] px-2 py-2 border-b-black ">
                Indoor Style
              </span>
            </h1>
