        ...
        <div className="wrap">
          ...
          <div className="content  ">
            <h1 className="relative  font-bolder  md:text-3xl lg:text-4xl ">
              <h1 className="bg-white border-b-[.1px]  border-b-black -[9px] px-2 py-2 ">
                Be Inspired With Dark
              </h1>
              <span className="bg-white border-b-[.1px]  border-b-black mb-[10px] px-2 py-1 ">
                Photo And Colorul
              </span>
              <br />
              <span className="bg-white border-b-[.1px] mt-[10px] px-2  border-b-black  ">
                Indoor Style
              </span>
            </h1>
