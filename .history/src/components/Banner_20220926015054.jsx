      ...
      <div className="container px-7 h-full md:w-[80%] md:mx-auto flex items-center ">
        <div className="wrap">
          ...
          <div className="content  ">
            <div className="relative  font-bolder text-[1.3rem] md:text-3xl lg:text-4xl  mb-3">
              <Link to="/Features" alt="Detail Address ">
                <h1 className="bg-white border-b-[.1px]  border-b-black  px-2 py-2 ">
                  Be Inspired With Dark
                </h1>
                <h1 className="bg-white border-b-[.1px]  border-b-black  px-2 py-1 w-fit ">
                  Photo And Colorful
                </h1>
                <h1 className="bg-white border-b-[.1px] px-2 py-2  border-b-black  w-fit ">
                  Indoor Style
                </h1>
              </Link>
            </div>
            ...
            <p className="profile text-[.7rem] flex items-center text-white font-bold">
              <p className="flex mr-6 items-center hover:text-gray-200 hover:cursor-pointer  text-[.5rem] md:text-[.7rem]">
