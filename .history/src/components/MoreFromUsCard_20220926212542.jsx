  ...
  return (
    <div className=" grid grid-cols-3 grid-rows-3 ">
      <p className="bg-red-200">
        Latibus, eos
        consequuntur. Suscipit est assumenda, modi sunt ipsa reicieorem ipsum dolor sit amet consectetur, adipisicing elit. Asperiores at
        facilis obcaecati dolorem dolorum amet. Necessitndis quod
