  ...
  return (
    <div className="font-bold text-2xl md:mt-[48px]">
      ...
      <div className="wrapper ">
        <div className=" wrap -translate-y-9 flex  justify-center items-end h-full">
          <div className=" PostCard-container  grid grid-cols-1 md:grid-cols-2 gap-6 overflow-x-scroll scrollbar-hide md:cursor-pointer mx:auto max-w-[78%] md:max-w-[60%] z-50 ">
