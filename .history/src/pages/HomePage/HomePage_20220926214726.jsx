  ...
  return (
    <div className="font-bold text-2xl md:mt-[48px]">
      ...
      <div className="Blog- flex flex-col ">
        <div className=" Overlapper -translate-y-9 flex  justify-center">
        ...
        <div className="MoreFromUs  container px-7 h-full md:w-[80%] md:mx-auto  ">
          <h2 className="text-md font-bold mb-3  "> More From Us</h2>
          <MoreFromUsCard />
        </div>
      </div>
    </div>
