  ...
  return (
    <div className="font-bold text-2xl md:mt-[48px]">
      ...
      <div className="Blog-CArds flex flex-col ">
        ...
        <div className="Articles pb-20">
          <div className="Articles  container px-7 h-full md:w-[80%] md:mx-auto  relative  bg-black">
            <h2 className="text-md font-bold mb-3 mt-8 text-center ">
              {" "}
              More From Us
            </h2>
          </div>
