      ...
      <div className="Blog-CArds flex flex-col ">
        ...
        <div className="Articles pb-20  bg-black">
          <div className="Articles  container px-7 h-full md:w-[80%] md:mx-auto  relative ">
            ...
            <div className="ArticleCards grid grid-cols-4 items-center justify-center w-full relative">
              <ArticlesSection addStyle=" cols-span-2 " />
              e="" />
              <ArticlesSection addStyle="" /><ArticlesSection addStyl
            </div>
          </div>
        </div>
