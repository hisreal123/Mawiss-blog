        ...
        <div className="Articles pb-20  bg-black">
          <div className="Articles  container px-7 h-full md:w-[80%] md:mx-auto  relative ">
            ...
            <div className="grid  grid-cols-4 gap-4 items-center justify-center w-full relative">
              ...
              <PostCard addStyles="col-span-1 h-[200px] flex text-white flex-col  justify-between  hidden" />
              <PostCard addStyles=" h-[200px] flex text-white flex-col  justify-between  hidden " />
            </div>
          </div>
        </div>
