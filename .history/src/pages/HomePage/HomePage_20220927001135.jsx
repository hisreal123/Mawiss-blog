        ...
        <div className="Articles pb-20  bg-black">
          <div className="Articles  container px-7 h-full md:w-[80%] md:mx-auto  relative ">
            ...
            <div className="flex items-center justify-center w-full relative overflow-auto overflow-x-scroll  ">
              <PostCard addStyles=" basis1/2 h-[200px] flex text-white flex-col  justify-between  " />
              <PostCard addStyles=" basis1/4 h-[200px] flex text-white flex-col  justify-between  " />
              <PostCard addStyles="basis1/ h-[200px] flex text-white flex-col  justify-between  " />
            </div>
          </div>
        </div>
