      ...
      <div className="Blog-CArds flex flex-col ">
        ...
        <div className="Articles pb-20  bg-black">
          <div className="Articles  container px-7 h-full md:w-[80%] md:mx-auto  relative ">
            ...
            <div className="flex items-center justify-center w-full relative  overflow-hidden flex-nowrap ">
              <PostCard addStyles="  h-[200px] flex text-white flex-col  justify-between  " />
              <PostCard addStyles="  h-[200px] flex text-white flex-col ml-2 justify-between  " />
              <PostCard addStyles="basis-1/4 h-[200px] flex text-white flex-col ml-2 justify-between  " />
            </div>
          </div>
        </div>
