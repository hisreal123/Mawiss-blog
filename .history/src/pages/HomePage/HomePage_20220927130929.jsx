  ...
  return (
    <div className="font-bold text-2xl md:mt-[48px]">
      ...
      <div className="Blog-CArds flex flex-col ">
        ...
        <div className="RecentPost mt-[100px] container px-7 lh-ful md:w-[80%] md:mx-auto  relative">
          <h1> Recent Post</h1>
          <div className="RecentPostCard grid grid-cols-4 gap-4 ">
            <MoreFromUsCard addStyle="" />
            <MoreFromUsCard addStyle="grid grid-rows-3 " />
            <MoreFromUsCard addStyle="grid grid-rows-3 " />
            <MoreFromUsCard addStyle="grid grid-rows-3 " />
            <MoreFromUsCard addStyle="grid grid-rows-3 " />
            <MoreFromUsCard addStyle="grid grid-rows-3 " />
