      ...
      <div className="wrapper ">
        <div className=" wrap -translate-y-9 flex  justify-center">
          <div className="flex overflow-x-scroll container scrollbar-hide md:cursor-pointer mx:auto max-w-[60%]  ">
            <PostCard addStyles=" md:shadow-xl rounded-md px-4  py-3 text-white h-[200px] shadow-3xl h-f" />
            <PostCard addStyles=" md:shadow-xl rounded-md px-4  py-3 ml-4 text-white h-[200px] shadow-3xl h-f" />
          </div>
        </div>
      </div>
    </h1>
